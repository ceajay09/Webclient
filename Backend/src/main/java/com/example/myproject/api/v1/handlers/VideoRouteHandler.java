package com.example.myproject.api.v1.handlers;
...
public class VideoRouteHandler {
     ...
     * videoResource.contentLength() is a blocking call, therefore it is wrapped in
     * a Mono.
     * it returns a FileNotFound exception which is wrapped and propagated down the
     * stream
     */
