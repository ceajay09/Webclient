package com.example.myproject.api.v1.errors;

import com.example.myproject.repository.helpers.Error;
...
public class CustomExceptionHandler extends WebFluxResponseStatusExceptionHandler {
    ...
    private String buildResponse(ServerWebExchange exchange, Throwable ex) {
        return ("Failed to handle error in request [" + exchange.getRequest().getMethod() + " "
